...
icon = Image("photo", file=resource_path("star.gif"))
...
entry2_img = PhotoImage(file = resource_path("img_textBox2.png"))
...
entry3_img = PhotoImage(file = resource_path("img_textBox3.png"))
...
entry4_img = PhotoImage(file = resource_path("img_textBox4.png"))
...
entry5_img = PhotoImage(file = resource_path("img_textBox5.png"))
